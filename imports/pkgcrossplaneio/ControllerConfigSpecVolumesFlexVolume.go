...
type ControllerConfigSpecVolumesFlexVolume struct {
	...
	// scripts.
	SecretRef *ControllerConfigSpecVolumesFlexVolumeSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
