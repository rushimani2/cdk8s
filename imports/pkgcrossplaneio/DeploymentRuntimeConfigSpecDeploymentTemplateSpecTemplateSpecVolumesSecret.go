...
type DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesSecret struct {
	...
	Items *[]*DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesSecretItems `field:"optional" json:"items" yaml:"items"`
