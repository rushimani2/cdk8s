...
type ControllerConfigSpec struct {
	...
	//
	// Cannot be updated.
	VolumeMounts *[]*ControllerConfigSpecVolumeMounts `field:"optional" json:"volumeMounts" yaml:"volumeMounts"`
	// List of volumes that can be mounted by containers belonging to the pod.
	//
	// More info: https://kubernetes.io/docs/concepts/storage/volumes
	Volumes *[]*ControllerConfigSpecVolumes `field:"optional" json:"volumes" yaml:"volumes"`
}
