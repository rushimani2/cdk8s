...
type FunctionRevisionV1Beta1Spec struct {
	...
	ControllerConfigRef *FunctionRevisionV1Beta1SpecControllerConfigRef `field:"optional" json:"controllerConfigRef" yaml:"controllerConfigRef"`
	...
	PackagePullSecrets *[]*FunctionRevisionV1Beta1SpecPackagePullSecrets `field:"optional" json:"packagePullSecrets" yaml:"packagePullSecrets"`
	// RuntimeConfigRef references a RuntimeConfig resource that will be used to configure the package runtime.
	RuntimeConfigRef *FunctionRevisionV1Beta1SpecRuntimeConfigRef `field:"optional" json:"runtimeConfigRef" yaml:"runtimeConfigRef"`
