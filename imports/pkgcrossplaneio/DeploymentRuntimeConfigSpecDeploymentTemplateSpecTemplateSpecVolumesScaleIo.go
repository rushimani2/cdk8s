...
type DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesScaleIo struct {
	...
	SecretRef *DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesScaleIoSecretRef `field:"required" json:"secretRef" yaml:"secretRef"`
