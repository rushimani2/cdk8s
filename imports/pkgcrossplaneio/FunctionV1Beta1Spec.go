...
type FunctionV1Beta1Spec struct {
	...
	ControllerConfigRef *FunctionV1Beta1SpecControllerConfigRef `field:"optional" json:"controllerConfigRef" yaml:"controllerConfigRef"`
	...
	PackagePullSecrets *[]*FunctionV1Beta1SpecPackagePullSecrets `field:"optional" json:"packagePullSecrets" yaml:"packagePullSecrets"`
	...
	RuntimeConfigRef *FunctionV1Beta1SpecRuntimeConfigRef `field:"optional" json:"runtimeConfigRef" yaml:"runtimeConfigRef"`
