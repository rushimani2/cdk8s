...
type ControllerConfigSpecVolumesProjectedSourcesConfigMap struct {
	...
	Items *[]*ControllerConfigSpecVolumesProjectedSourcesConfigMapItems `field:"optional" json:"items" yaml:"items"`
