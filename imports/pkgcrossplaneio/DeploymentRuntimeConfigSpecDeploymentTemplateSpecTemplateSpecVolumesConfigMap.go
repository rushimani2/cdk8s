...
type DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesConfigMap struct {
	...
	Items *[]*DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesConfigMapItems `field:"optional" json:"items" yaml:"items"`
