...
type FunctionRevisionSpec struct {
	...
	ControllerConfigRef *FunctionRevisionSpecControllerConfigRef `field:"optional" json:"controllerConfigRef" yaml:"controllerConfigRef"`
	...
	PackagePullSecrets *[]*FunctionRevisionSpecPackagePullSecrets `field:"optional" json:"packagePullSecrets" yaml:"packagePullSecrets"`
	// RuntimeConfigRef references a RuntimeConfig resource that will be used to configure the package runtime.
	RuntimeConfigRef *FunctionRevisionSpecRuntimeConfigRef `field:"optional" json:"runtimeConfigRef" yaml:"runtimeConfigRef"`
