...
type DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesIscsi struct {
	...
	SecretRef *DeploymentRuntimeConfigSpecDeploymentTemplateSpecTemplateSpecVolumesIscsiSecretRef `field:"optional" json:"secretRef" yaml:"secretRef"`
}
