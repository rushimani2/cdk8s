...
type ControllerConfigSpecVolumesProjectedSourcesSecret struct {
	...
	Items *[]*ControllerConfigSpecVolumesProjectedSourcesSecretItems `field:"optional" json:"items" yaml:"items"`
