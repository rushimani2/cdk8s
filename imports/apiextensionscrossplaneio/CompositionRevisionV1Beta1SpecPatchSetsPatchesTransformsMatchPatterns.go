...
type CompositionRevisionV1Beta1SpecPatchSetsPatchesTransformsMatchPatterns struct {
	...
	Type CompositionRevisionV1Beta1SpecPatchSetsPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
