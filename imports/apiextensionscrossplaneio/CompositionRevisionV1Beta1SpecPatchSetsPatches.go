...
type CompositionRevisionV1Beta1SpecPatchSetsPatches struct {
	// Combine is the patch configuration for a CombineFromComposite or CombineToComposite patch.
	Combine *CompositionRevisionV1Beta1SpecPatchSetsPatchesCombine `field:"optional" json:"combine" yaml:"combine"`
	...
	Policy *CompositionRevisionV1Beta1SpecPatchSetsPatchesPolicy `field:"optional" json:"policy" yaml:"policy"`
	...
	Transforms *[]*CompositionRevisionV1Beta1SpecPatchSetsPatchesTransforms `field:"optional" json:"transforms" yaml:"transforms"`
	// Type sets the patching behaviour to be used.
	//
	// Each patch type may require
	// its own fields to be set on the Patch object.
	Type CompositionRevisionV1Beta1SpecPatchSetsPatchesType `field:"optional" json:"type" yaml:"type"`
}
