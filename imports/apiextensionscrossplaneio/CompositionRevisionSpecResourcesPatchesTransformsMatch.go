...
type CompositionRevisionSpecResourcesPatchesTransformsMatch struct {
	// Determines to what value the transform should fallback if no pattern matches.
	FallbackTo CompositionRevisionSpecResourcesPatchesTransformsMatchFallbackTo `field:"optional" json:"fallbackTo" yaml:"fallbackTo"`
	...
	Patterns *[]*CompositionRevisionSpecResourcesPatchesTransformsMatchPatterns `field:"optional" json:"patterns" yaml:"patterns"`
}
