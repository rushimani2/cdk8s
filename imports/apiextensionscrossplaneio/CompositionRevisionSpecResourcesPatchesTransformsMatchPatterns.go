...
type CompositionRevisionSpecResourcesPatchesTransformsMatchPatterns struct {
	...
	Type CompositionRevisionSpecResourcesPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
