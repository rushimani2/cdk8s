...
type CompositionRevisionV1Beta1Spec struct {
	// CompositeTypeRef specifies the type of composite resource that this composition is compatible with.
	CompositeTypeRef *CompositionRevisionV1Beta1SpecCompositeTypeRef `field:"required" json:"compositeTypeRef" yaml:"compositeTypeRef"`
	...
	Mode CompositionRevisionV1Beta1SpecMode `field:"optional" json:"mode" yaml:"mode"`
	...
	PatchSets *[]*CompositionRevisionV1Beta1SpecPatchSets `field:"optional" json:"patchSets" yaml:"patchSets"`
	...
	Pipeline *[]*CompositionRevisionV1Beta1SpecPipeline `field:"optional" json:"pipeline" yaml:"pipeline"`
	...
	PublishConnectionDetailsWithStoreConfigRef *CompositionRevisionV1Beta1SpecPublishConnectionDetailsWithStoreConfigRef `field:"optional" json:"publishConnectionDetailsWithStoreConfigRef" yaml:"publishConnectionDetailsWithStoreConfigRef"`
	...
	//
	// Deprecated: Use Composition Functions instead.
	Resources *[]*CompositionRevisionV1Beta1SpecResources `field:"optional" json:"resources" yaml:"resources"`
