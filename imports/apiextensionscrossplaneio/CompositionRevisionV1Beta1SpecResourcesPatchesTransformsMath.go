...
type CompositionRevisionV1Beta1SpecResourcesPatchesTransformsMath struct {
	...
	Type CompositionRevisionV1Beta1SpecResourcesPatchesTransformsMathType `field:"optional" json:"type" yaml:"type"`
}
