...
type CompositionRevisionSpecPatchSetsPatchesTransformsMatchPatterns struct {
	...
	Type CompositionRevisionSpecPatchSetsPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
