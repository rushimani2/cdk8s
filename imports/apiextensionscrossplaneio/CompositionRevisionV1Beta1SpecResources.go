...
type CompositionRevisionV1Beta1SpecResources struct {
	...
	ConnectionDetails *[]*CompositionRevisionV1Beta1SpecResourcesConnectionDetails `field:"optional" json:"connectionDetails" yaml:"connectionDetails"`
	// A Name uniquely identifies this entry within its Composition's resources array.
	//
	// Names are optional but *strongly* recommended. When all entries in
	...
	Patches *[]*CompositionRevisionV1Beta1SpecResourcesPatches `field:"optional" json:"patches" yaml:"patches"`
	// ReadinessChecks allows users to define custom readiness checks.
	//
	// All checks
	// have to return true in order for resource to be considered ready. The
	// default readiness check is to have the "Ready" condition to be "True".
	ReadinessChecks *[]*CompositionRevisionV1Beta1SpecResourcesReadinessChecks `field:"optional" json:"readinessChecks" yaml:"readinessChecks"`
}
