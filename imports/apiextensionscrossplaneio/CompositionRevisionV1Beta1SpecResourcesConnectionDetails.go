...
type CompositionRevisionV1Beta1SpecResourcesConnectionDetails struct {
	...
	//
	// Name must be specified if the type is
	// FromFieldPath.
	...
	// 3. FromFieldPath
	Type CompositionRevisionV1Beta1SpecResourcesConnectionDetailsType `field:"optional" json:"type" yaml:"type"`
	// Value that will be propagated to the connection secret of the composite resource.
	//
	// May be set to inject a fixed, non-sensitive connection secret
