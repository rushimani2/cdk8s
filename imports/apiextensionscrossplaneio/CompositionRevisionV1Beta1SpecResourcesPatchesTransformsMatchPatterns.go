...
type CompositionRevisionV1Beta1SpecResourcesPatchesTransformsMatchPatterns struct {
	...
	Type CompositionRevisionV1Beta1SpecResourcesPatchesTransformsMatchPatternsType `field:"required" json:"type" yaml:"type"`
