...
type CompositionRevisionV1Beta1SpecResourcesPatches struct {
	// Combine is the patch configuration for a CombineFromComposite or CombineToComposite patch.
	Combine *CompositionRevisionV1Beta1SpecResourcesPatchesCombine `field:"optional" json:"combine" yaml:"combine"`
	// FromFieldPath is the path of the field on the resource whose value is to be used as input.
	//
	// Required when type is FromCompositeFieldPath or
	...
	Policy *CompositionRevisionV1Beta1SpecResourcesPatchesPolicy `field:"optional" json:"policy" yaml:"policy"`
	// ToFieldPath is the path of the field on the resource whose value will be changed with the result of transforms.
	//
	// Leave empty if you'd like to
	...
	Transforms *[]*CompositionRevisionV1Beta1SpecResourcesPatchesTransforms `field:"optional" json:"transforms" yaml:"transforms"`
	// Type sets the patching behaviour to be used.
	//
	// Each patch type may require
	// its own fields to be set on the Patch object.
	Type CompositionRevisionV1Beta1SpecResourcesPatchesType `field:"optional" json:"type" yaml:"type"`
}
