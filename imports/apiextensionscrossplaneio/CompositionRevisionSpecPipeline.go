...
type CompositionRevisionSpecPipeline struct {
	// FunctionRef is a reference to the Composition Function this step should execute.
	FunctionRef *CompositionRevisionSpecPipelineFunctionRef `field:"required" json:"functionRef" yaml:"functionRef"`
	// Step name.
	//
	...
	Credentials *[]*CompositionRevisionSpecPipelineCredentials `field:"optional" json:"credentials" yaml:"credentials"`
