...
type NetworkPolicySpecIngress struct {
	...
	Destination *NetworkPolicySpecIngressDestination `field:"optional" json:"destination" yaml:"destination"`
	// HTTP contains match criteria that apply to HTTP requests.
	Http *NetworkPolicySpecIngressHttp `field:"optional" json:"http" yaml:"http"`
	...
	Icmp *NetworkPolicySpecIngressIcmp `field:"optional" json:"icmp" yaml:"icmp"`
	...
	Metadata *NetworkPolicySpecIngressMetadata `field:"optional" json:"metadata" yaml:"metadata"`
	// NotICMP is the negated version of the ICMP field.
	NotIcmp *NetworkPolicySpecIngressNotIcmp `field:"optional" json:"notIcmp" yaml:"notIcmp"`
	// NotProtocol is the negated version of the Protocol field.
	NotProtocol NetworkPolicySpecIngressNotProtocol `field:"optional" json:"notProtocol" yaml:"notProtocol"`
	...
	Protocol NetworkPolicySpecIngressProtocol `field:"optional" json:"protocol" yaml:"protocol"`
	// Source contains the match criteria that apply to source entity.
	Source *NetworkPolicySpecIngressSource `field:"optional" json:"source" yaml:"source"`
}
