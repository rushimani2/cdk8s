...
type NetworkPolicySpecIngressDestination struct {
	...
	NotPorts *[]NetworkPolicySpecIngressDestinationNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]NetworkPolicySpecIngressDestinationPorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *NetworkPolicySpecIngressDestinationServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *NetworkPolicySpecIngressDestinationServices `field:"optional" json:"services" yaml:"services"`
}
