...
type GlobalNetworkPolicySpecEgress struct {
	Action *string `field:"required" json:"action" yaml:"action"`
	// Destination contains the match criteria that apply to destination entity.
	Destination *GlobalNetworkPolicySpecEgressDestination `field:"optional" json:"destination" yaml:"destination"`
	// HTTP contains match criteria that apply to HTTP requests.
	Http *GlobalNetworkPolicySpecEgressHttp `field:"optional" json:"http" yaml:"http"`
	...
	Icmp *GlobalNetworkPolicySpecEgressIcmp `field:"optional" json:"icmp" yaml:"icmp"`
	...
	Metadata *GlobalNetworkPolicySpecEgressMetadata `field:"optional" json:"metadata" yaml:"metadata"`
	// NotICMP is the negated version of the ICMP field.
	NotIcmp *GlobalNetworkPolicySpecEgressNotIcmp `field:"optional" json:"notIcmp" yaml:"notIcmp"`
	// NotProtocol is the negated version of the Protocol field.
	NotProtocol GlobalNetworkPolicySpecEgressNotProtocol `field:"optional" json:"notProtocol" yaml:"notProtocol"`
	...
	Protocol GlobalNetworkPolicySpecEgressProtocol `field:"optional" json:"protocol" yaml:"protocol"`
	// Source contains the match criteria that apply to source entity.
	Source *GlobalNetworkPolicySpecEgressSource `field:"optional" json:"source" yaml:"source"`
}
