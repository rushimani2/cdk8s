...
type NetworkPolicySpecIngressSource struct {
	...
	NotPorts *[]NetworkPolicySpecIngressSourceNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]NetworkPolicySpecIngressSourcePorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *NetworkPolicySpecIngressSourceServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *NetworkPolicySpecIngressSourceServices `field:"optional" json:"services" yaml:"services"`
}
