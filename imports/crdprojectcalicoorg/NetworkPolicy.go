...
func (j *jsiiProxy_NetworkPolicy) Chart() cdk8s.Chart {
...
// Defines a "NetworkPolicy" API object.
...
func NetworkPolicy_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkPolicy_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
// Renders a Kubernetes manifest for "NetworkPolicy".
//
// This can be used to inline resource manifests inside other objects (e.g. as templates).
func NetworkPolicy_Manifest(props *NetworkPolicyProps) interface{} {
	_init_.Initialize()

	if err := validateNetworkPolicy_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func NetworkPolicy_Of(c constructs.IConstruct) cdk8s.ApiObject {
	_init_.Initialize()

	if err := validateNetworkPolicy_OfParameters(c); err != nil {
		panic(err)
	}
...
func NetworkPolicy_GVK() *cdk8s.GroupVersionKind {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkPolicy) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (n *jsiiProxy_NetworkPolicy) AddJsonPatch(ops ...cdk8s.JsonPatch) {
	args := []interface{}{}
	for _, a := range ops {
		args = append(args, a)
	}
...
func (n *jsiiProxy_NetworkPolicy) ToJson() interface{} {
	var returns interface{}
