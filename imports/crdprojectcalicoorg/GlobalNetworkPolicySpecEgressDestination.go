...
type GlobalNetworkPolicySpecEgressDestination struct {
	...
	NotPorts *[]GlobalNetworkPolicySpecEgressDestinationNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]GlobalNetworkPolicySpecEgressDestinationPorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *GlobalNetworkPolicySpecEgressDestinationServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *GlobalNetworkPolicySpecEgressDestinationServices `field:"optional" json:"services" yaml:"services"`
}
