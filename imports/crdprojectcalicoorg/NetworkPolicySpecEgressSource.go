...
type NetworkPolicySpecEgressSource struct {
	...
	NotPorts *[]NetworkPolicySpecEgressSourceNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]NetworkPolicySpecEgressSourcePorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *NetworkPolicySpecEgressSourceServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *NetworkPolicySpecEgressSourceServices `field:"optional" json:"services" yaml:"services"`
}
