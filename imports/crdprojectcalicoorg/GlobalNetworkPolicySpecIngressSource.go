...
type GlobalNetworkPolicySpecIngressSource struct {
	...
	NotPorts *[]GlobalNetworkPolicySpecIngressSourceNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]GlobalNetworkPolicySpecIngressSourcePorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *GlobalNetworkPolicySpecIngressSourceServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *GlobalNetworkPolicySpecIngressSourceServices `field:"optional" json:"services" yaml:"services"`
}
