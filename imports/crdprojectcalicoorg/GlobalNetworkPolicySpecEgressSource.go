...
type GlobalNetworkPolicySpecEgressSource struct {
	...
	NotPorts *[]GlobalNetworkPolicySpecEgressSourceNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]GlobalNetworkPolicySpecEgressSourcePorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *GlobalNetworkPolicySpecEgressSourceServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *GlobalNetworkPolicySpecEgressSourceServices `field:"optional" json:"services" yaml:"services"`
}
