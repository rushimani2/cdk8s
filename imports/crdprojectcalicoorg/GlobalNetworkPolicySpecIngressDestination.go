...
type GlobalNetworkPolicySpecIngressDestination struct {
	...
	NotPorts *[]GlobalNetworkPolicySpecIngressDestinationNotPorts `field:"optional" json:"notPorts" yaml:"notPorts"`
	...
	// Since only some protocols have ports, if any ports are specified it requires the Protocol match in the Rule to be set to "TCP" or "UDP".
	Ports *[]GlobalNetworkPolicySpecIngressDestinationPorts `field:"optional" json:"ports" yaml:"ports"`
	...
	ServiceAccounts *GlobalNetworkPolicySpecIngressDestinationServiceAccounts `field:"optional" json:"serviceAccounts" yaml:"serviceAccounts"`
	...
	Services *GlobalNetworkPolicySpecIngressDestinationServices `field:"optional" json:"services" yaml:"services"`
}
