...
type NetworkPolicySpecEgress struct {
	...
	Destination *NetworkPolicySpecEgressDestination `field:"optional" json:"destination" yaml:"destination"`
	// HTTP contains match criteria that apply to HTTP requests.
	Http *NetworkPolicySpecEgressHttp `field:"optional" json:"http" yaml:"http"`
	...
	Icmp *NetworkPolicySpecEgressIcmp `field:"optional" json:"icmp" yaml:"icmp"`
	...
	Metadata *NetworkPolicySpecEgressMetadata `field:"optional" json:"metadata" yaml:"metadata"`
	// NotICMP is the negated version of the ICMP field.
	NotIcmp *NetworkPolicySpecEgressNotIcmp `field:"optional" json:"notIcmp" yaml:"notIcmp"`
	// NotProtocol is the negated version of the Protocol field.
	NotProtocol NetworkPolicySpecEgressNotProtocol `field:"optional" json:"notProtocol" yaml:"notProtocol"`
	...
	Protocol NetworkPolicySpecEgressProtocol `field:"optional" json:"protocol" yaml:"protocol"`
	// Source contains the match criteria that apply to source entity.
	Source *NetworkPolicySpecEgressSource `field:"optional" json:"source" yaml:"source"`
}
